          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-blue-900/80">
                ...
                een account oefen je onbeperkt.
              </p>
            </div>
        ...
        <section className="mt-12 grid gap-6 md:grid-cols-2">
          ...
          >
            ...
            <p className="mt-5 leading-7 text-slate-600">
              Kies een rechtsgebied en ̩̩n of meerdere leerstukken. Daarna krijg
            ...
            <div className="mt-4 rounded-2xl border border-green-200 bg-green-50 p-5">
              <p className="font-semibold text-green-800">Gratis toegang</p>
          ...
          >
            ...
            <p className="mt-5 leading-7 text-slate-600">
              Kies een rechtsgebied en oefen ̩̩n leerstuk of een mix van
