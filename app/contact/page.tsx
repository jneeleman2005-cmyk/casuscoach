          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-slate-600">
                <li>Ã¢Å“â€œ Feedback op MC-vragen of casussen</li>
                <li>Ã¢Å“â€œ Een fout in een antwoord of uitleg</li>
                <li>Ã¢Å“â€œ Vragen over account of toegang</li>
                <li>Ã¢Å“â€œ IdeeÃƒÂ«n voor nieuwe rechtsgebieden of leerstukken</li>
              </ul>
            </div>
          </div>
